...
-- Deux systèmes, pas un : une intervention en porte plusieurs depuis D116, et la matrice RLS de
...
-- Le système principal est aussi une liaison (D116) : `saveLog` écrit les deux, la reprise de
-- `0033` aussi, et une intervention posée ici sans elle ne ressemblerait à aucune vraie ligne.
