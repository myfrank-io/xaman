...
comment on column public.boat_invitations.reminded_at is
  'When the invitation was last resent by hand (D109). Null when it never was. Written by the '
...
comment on column public.boat_invitations.reminder_count is
  'How many manual reminders went out for this invitation (D109). Shown on the Membres screen: '
