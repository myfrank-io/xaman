-- 0037_boat_activity.sql — E18-3 / D126: le fil du carnet, ce qui a eu lieu.
--
...
--
-- Ce que le fil ne montre pas (D126) : les mises à la corbeille et les modifications. Ce n'est
...
comment on view public.boat_activity is
  'The carnet''s shared feed (D126): what happened — points ticked, interventions done, purchases, manual hour readings, haul-outs — newest first, with who did it. Facts only: nothing here says what was trashed or edited. security_invoker, so each source table''s RLS decides.';
