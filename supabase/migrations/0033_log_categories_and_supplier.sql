-- 0033_log_categories_and_supplier.sql — une intervention porte plusieurs systèmes (D116).
--
...
comment on table public.maintenance_log_categories is
  'Les systèmes d''une intervention (D116). Le principal reste maintenance_logs.category_id ; cette table les porte tous, lui compris.';
