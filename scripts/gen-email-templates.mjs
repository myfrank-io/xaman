...
const APP_TEMPLATE_KEYS = ["invite", "recovery", "inbox_ready", "inbox_validated", "handoff"];
...
// identical to their supabase/templates/*.html counterparts, the two e-mails of the inbox (D91)
// and the hand-over to the yard (D141), which only the app sends.
