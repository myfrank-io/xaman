...
const APP_TEMPLATE_KEYS = ["invite", "recovery", "inbox_ready", "inbox_validated"];
...
/**
 * E-mails only the app sends (D84): no `supabase/templates/` file, no `config.toml` block — Auth
...
// identical to their supabase/templates/*.html counterparts, and the two e-mails of the inbox
// (D84), which only the app sends.
