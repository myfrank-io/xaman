 ...
 * filed, and an inventory read off a builder's list (D128), whose card sends its lines to the
...
const ITEMS: InboxItem[] = [
  ...
  },
  {
    ...
    suggestion: {
      ...
      validUntil: null,
      documentFamily: "maintenance_invoice",
      batch: [],
      confidence: "medium",
      inventory: [],
  ...
  },
  {
    ...
    suggestion: {
      ...
      documentFamily: "inspection_certificate",
      batch: [],
      confidence: "high",
      inventory: [],
      warnings: [],
  ...
  },
  {
    ...
    suggestion: {
      ...
      validUntil: null,
      confidence: "high",
      // E17-1 reads this family as a batch; this card is the E2-10 path, which fills the
      // equipment list through the import rather than proposing lines of its own.
