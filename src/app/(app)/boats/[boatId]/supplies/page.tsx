...
import { stockPath, suppliesPath } from "@/lib/queries/boat-routes";
...
export default async function SuppliesPage({
  ...
  const [t, tk] = await Promise.all([getTranslations("supplies"), getTranslations("purchaseKind")]);
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader title={t("title")} subtitle={t("expenses.subtitle")} />
      {kind === "gas" ? (
