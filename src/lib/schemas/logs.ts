...
/** How many systems one intervention may carry (D114): a boat has a dozen, a visit never all. */
...
export const saveLogSchema = z
  .object({
    ...
    /**
     * The systems this intervention touches (D114). One visit of the mechanic is often three
...
/** The system the row keeps in its own column: the first one chosen (D114). */
