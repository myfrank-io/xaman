...
/**
 * What the dialog opens on when a document named the provider (D116): everything the invoice
 ...
 *
 * With `initial` it is the same dialogue, pre-filled from what was read on a document (D116),
