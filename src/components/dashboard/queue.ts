...
/**
 * Une ligne de la file : tout ce qui attend quelqu'un sur ce bateau (D122).
 *
...
/**
 * Les paliers de la file (D121, D122, E18-1, E18-2).
 *
 ...
 * exactement ce que le bandeau disait avant d'être une ligne (D122).
 */
