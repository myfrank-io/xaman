...
## 2026-09-14 — D122 : la maquette est faite de matières, et elle dit qu'on peut la toucher
...
## 2026-09-14 — D123 : un document de chantier verse l'inventaire dans l'import qui existe déjà

**Question.** La maquette (D117, D122) se précise avec ce que le carnet sait du bateau : elle lit
