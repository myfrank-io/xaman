...
- [~] **E4-13 (M, 3)** Reprise de la checklist après usage (D149) : urgences distinctes de l’historique absent, consignes en place, cochage rapide et annulation locale, compteurs anciens confirmés, contexte conservé. Tests des parcours complets et recette tactile.
