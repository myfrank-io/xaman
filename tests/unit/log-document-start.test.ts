...
/**
 * Une intervention commence par son document (D119) — et ce que la lecture propose se traduit dans
...
describe("le formulaire pré-rempli par le document (D119)", () => {
  ...
  it("retombe sur le nom seul quand la lecture est antérieure au bloc prestataire (D120)", () => {
