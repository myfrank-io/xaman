...
describe("insert", () => {
  ...
  // D66, migration 0019. A published catalogue: it holds nobody's data, so it carries no boat_id
...
describe("create_boat", () => {
  ...
  /**
   * D66. Tapping « Lagoon 42 » in the suggestions is worth more than the two words it types: the
