...
describe("the reading, made safe", () => {
    ...
    const suggestion = normaliseSuggestion(
      {
        ...
        // Nothing said about the provider at all: the fallback matching (D116) has no name, no
  ...
  /**
   * D116: the reading missed the link, the annuaire has it. An exact e-mail is a certainty, and
...
describe("validating a card", () => {
  ...
  /** D114: an invoice that covers three systems files the intervention under the three. */
